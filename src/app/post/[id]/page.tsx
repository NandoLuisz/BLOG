    ...
    <section className="w-full min-h-screen relative">
      ...
      <div className="w-full flex flex-col items-center gap-4">
        <div className="flex gap-2">
          ...
          <p className="font-poppins">{DateFormat(postPage.createdAt)}</p>
        </div>
        <h1 className="text-5xl font-semibold">{postPage.title}</h1>
        <img src={postPage.creator.imageProfile} alt="" className="w-[80px] h-[80px] object-cover border-3 border-white rounded-full"/>
        <p className="text-xl font-serif">{postPage.creator.name}</p>
        <img src={postPage.imageURL} alt="" className="w-[60%] h-[500px] object-cover border-3 border-white"/>
